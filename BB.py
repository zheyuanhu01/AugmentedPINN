...
class PINN_XPINN:
    ...
    def get_loss_xpinn(self):
        ...
        f1a = self.PDE1(u1, u1_t, u1_x, v1_x)
        f1b = self.PDE2(u1, v1, v1_t, u1_x, v1_x, u1_xxx) 
        f2a = self.PDE1(u2, u2_t, u2_x, v2_x)
        f2b = self.PDE2(u2, v2, v2_t, u2_x, v2_x, u2_xxx) 
        ...
        # Residuals 
        mse_f1 = f1a.square().mean() + f1b.square().mean()
        mse_f2 = f2a.square().mean() + f2b.square().mean()
